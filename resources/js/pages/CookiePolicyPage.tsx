...
import { Calendar, Cookie, Eye, Globe, Settings, Shield } from 'lucide-react';
        ...
        <HomeLayout hasSidebar>
            ...
            <div className="mb-8 rounded-lg bg-white p-6 shadow-sm">
                <div className="mb-4 flex items-center space-x-3">
                    <Cookie className="h-8 w-8 text-red-500" />
            ...
            {/* What are Cookies */}
            <div className="mb-8 rounded-lg bg-white p-6 shadow-sm">
                <h2 className="mb-4 text-2xl font-bold text-gray-900">কুকিজ কী?</h2>
                <div className="space-y-4 text-gray-600">
                    <p>
                        কুকিজ হলো ছোট টেক্সট ফাইল যা আপনার ডিভাইসে (কম্পিউটার, ট্যাবলেট বা মোবাইল) সংরক্ষিত হয় যখন আপনি আমাদের ওয়েবসাইট ভিজিট করেন।
                        এগুলো ওয়েবসাইটকে আপনার ডিভাইস চিনতে এবং আপনার পছন্দ মনে রাখতে সাহায্য করে।
                    </p>
                    <p>কুকিজ আপনার ব্রাউজিং অভিজ্ঞতা উন্নত করে, ওয়েবসাইটের কার্যকারিতা বৃদ্ধি করে এবং আমাদের সেবার মান উন্নতিতে সহায়তা করে।</p>
                </div>
            </div>

            {/* Cookie Types */}
            <div className="mb-8 rounded-lg bg-white p-6 shadow-sm">
                <h2 className="mb-6 text-2xl font-bold text-gray-900">কুকিজের ধরন</h2>
                        ...
                        <div key={index} className="rounded-lg border border-gray-200 p-4">
                            <div className="mb-3 flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-2">
                                    {type.required && <span className="rounded bg-red-100 px-2 py-1 text-xs text-red-500">প্রয়োজনীয়</span>}
                            ...
                            <div>
                                <h4 className="mb-2 font-medium text-gray-900">উদাহরণ:</h4>
            ...
            {/* How We Use Cookies */}
            <div className="mb-8 rounded-lg bg-white p-6 shadow-sm">
                <h2 className="mb-4 text-2xl font-bold text-gray-900">আমরা কীভাবে কুকিজ ব্যবহার করি</h2>
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="rounded-lg border border-orange-200 bg-orange-50 p-4">
                        <h3 className="mb-3 flex items-center font-semibold text-orange-900">
            ...
            {/* Managing Cookies */}
            <div className="mb-8 rounded-lg bg-white p-6 shadow-sm">
                <h2 className="mb-4 text-2xl font-bold text-gray-900">কুকিজ নিয়ন্ত্রণ করুন</h2>
                <div className="space-y-4 text-gray-600">
                    <p>
                        আপনি আপনার ব্রাউজার সেটিংস থেকে কুকিজ নিয়ন্ত্রণ করতে পারেন। বেশিরভাগ ব্রাউজার স্বয়ংক্রিয়ভাবে কুকিজ গ্রহণ করে, তবে আপনি
                        চাইলে এটি পরিবর্তন করতে পারেন।
                    </p>
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm">
                <h2 className="mb-4 text-2xl font-bold text-gray-900">আপনার কুকি সেটিংস</h2>
                <p className="mb-6 text-gray-600">নিচের সেটিংস ব্যবহার করে আপনি কোন ধরনের কুকিজ গ্রহণ করবেন তা নির্ধারণ করতে পারেন:</p>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={saveSettings} className="rounded-lg bg-red-600 px-6 py-2 text-white transition-colors hover:bg-red-700">
                        সেটিংস সংরক্ষণ করুন
                    </button>
                </div>
            </div>
