...
const getVisibleLinks = (
    ...
    for (let i = 1; i <= lastPage; i++) {
        if (i === 1 || i === lastPage || (i >= currentPage - pagesToShow && i <= currentPage + pagesToShow)) {
...
const PaginationNav: React.FC<PaginationProps> = ({ currentPage, lastPage, prevPageUrl, nextPageUrl, links }) => {
...
export { getVisibleLinks, PaginationNav };
