        ...
        <HomeLayout>
            ...
            <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="mb-12 text-center">
                    ...
                    <p className="mt-4 text-lg text-gray-600">মাসিক হরেকৃষ্ণ সমাচার এর বিভিন্ন সংবাদ বিভাগসমূহ।</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {categories.map((category) => (
                            <Link
                                ...
                                className="group block overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-md transition-shadow hover:shadow-lg"
                            >
                                <div className="flex items-center justify-between p-6">
                                    <div>
                                        <div className="flex items-center gap-3">
                                            <Stars className="h-6 w-6 text-red-500" />
                                    ...
                                    {category.articles_count > 0 && (
                                        <div className="flex flex-col items-center">
                                            <span className="text-3xl text-gray-400 transition-colors group-hover:text-red-400">
                                                {category.articles_count} <br />
                                            </span>
                                            <span className="text-sm text-gray-400 capitalize transition-colors group-hover:text-red-400">posts</span>
                                        </div>
                                    )}
                                </div>
                            </Link>
