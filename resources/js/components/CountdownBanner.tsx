...
const Banner: React.FC<{ quote: QuotationProps | null }> = ({ quote }) => {
    ...
    return (
        <div className={clsx('relative overflow-hidden rounded-lg p-6 shadow-lg', style.wrapper)}>
            ...
            <div className="relative z-10 flex flex-col items-center space-y-5 text-left md:flex-row md:justify-between md:space-y-0">
                <div className={clsx('transition-all duration-700', isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0')}>
