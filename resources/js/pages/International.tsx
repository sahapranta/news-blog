    ...
    return (
        <HomeLayout>
            <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h1 className="mb-6 border-b-4 border-red-600 pb-4 text-3xl font-bold text-gray-900">আন্তর্জাতিক</h1>
                    <p className="text-lg text-gray-600">বিশ্বের সর্বশেষ সংবাদ, আন্তর্জাতিক রাজনীতি, অর্থনীতি ও গুরুত্বপূর্ণ ঘটনাবলী</p>
                </div>
