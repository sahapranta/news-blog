...
const AboutPage: React.FC = () => {
  ...
  const Heading = (<div className="mb-8">
    ...
    <p className="text-gray-600 text-lg">
      হরেকৃষ্ণ সমাচার - বিশ্বস্ত সংবাদ, সৎ মতামত এবং নিরপেক্ষ বিশ্লেষণের জন্য আপনার নির্ভরযোগ্য সূত্র
    </p>
  </div>);
    ...
    <HomeLayout hasSidebar heading={Heading}>
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-lg p-8 mb-8 text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-4">হরেকৃষ্ণ সমাচার</h2>
            <p className="text-red-100 mb-6 leading-relaxed">
              ১৯৪০ সাল থেকে বাংলা ভাষাভাষী মানুষের কাছে বিশ্বস্ত সংবাদ পৌঁছে দিচ্ছি। আমরা নিরপেক্ষ, সত্য এবং মানসম্পন্ন সাংবাদিকতার মাধ্যমে সমাজের সেবা করে যাচ্ছি।
            </p>
            <div className="flex items-center space-x-4">
              <div className="text-center">
                <div className="text-2xl font-bold">৮০+</div>
                <div className="text-red-100 text-sm">বছরের অভিজ্ঞতা</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">২৪/৭</div>
                <div className="text-red-100 text-sm">সংবাদ সেবা</div>
              </div>
            </div>
          </div>
          <div className="text-center">
            <div className="bg-white/20 rounded-lg p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">বিশ্বব্যাপী নেটওয়ার্ক</h3>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">আমাদের পরিসংখ্যান</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            বাংলা ভাষাভাষী মানুষের কাছে বিশ্বস্ত, নিরপেক্ষ এবং মানসম্পন্ন সংবাদ পৌঁছে দেওয়া। আমরা চাই প্রতিটি মানুষ সঠিক তথ্যের ভিত্তিতে সিদ্ধান্ত নিতে পারুক।
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            একটি অবহিত, শিক্ষিত এবং গণতান্ত্রিক সমাজ গড়ে তোলা যেখানে মানুষ সত্যের ভিত্তিতে মতামত গঠন করতে পারে এবং স্বাধীনভাবে চিন্তা করতে পারে।
          </p>
        </div>
      </div>
      ...
      {/* Values */}
      <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">আমাদের মূল্যবোধ</h2>
        ...
        <div className="space-y-6">
          {milestones.map((milestone, index) => (
            <div key={index} className="flex items-start space-x-4">
              <div className="bg-red-500 text-white rounded-full w-16 h-16 flex items-center justify-center font-bold text-sm flex-shrink-0">
                {milestone.year}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, index) => (
            <div key={index} className="text-center">
              ...
              <p className="text-red-500 text-sm mb-2">{member.position}</p>
